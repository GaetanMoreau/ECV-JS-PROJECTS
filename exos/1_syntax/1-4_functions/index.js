...
const hello = direBonjour("Gaëtan")
console.log(hello)
/**========================================================================
 *                           Somme
 *========================================================================**/
...
function calculer(nb1) {
    const augmente = nb1 * (1 + (13 / 100))
    return augmente
}
const augmentation = calculer(20)
...
const bouclesomme = boucle(10, 20)
console.log(bouclesomme)
/**========================================================================
 *                           [Bonus] Limite
 *========================================================================**/
